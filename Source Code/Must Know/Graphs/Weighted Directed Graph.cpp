...
/*
	...
	n a weighted graph, each edge will have weight (or cost) associated with it, as shown below:
...
int main()
{
	...
	//inpuyt array containing edges of the graph (as per the above diagram)
